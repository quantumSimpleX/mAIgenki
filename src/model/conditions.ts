...
export type SupportedLang = 'en' | 'ja' | 'es' | 'fr' | 'zh' | 'ko'
...
export const SYSTEM_META: Record<SystemId, { label: string; color: string }> = {
  ...
  repro:   { label: 'Reproductive',  color: '#7F1D1D' },
}
...
export const CONDITIONS: DesignCondition[] = [
  {
    ...
    localNames: { ja: 'アトピー性皮膚炎', es: 'Dermatitis atópica', fr: 'Dermatite atopique', zh: '特应性皮炎', ko: '아토피성 피부염' },
  ...
  },
  {
    ...
    localNames: { ja: '尋常性乾癬', es: 'Psoriasis en placas', fr: 'Psoriasis en plaques', zh: '银屑病', ko: '건선' },
  ...
  },
  {
    ...
    localNames: { ja: '線維筋痛症', es: 'Fibromialgia', fr: 'Fibromyalgie', zh: '纤维肌痛症', ko: '섬유근육통' },
  ...
  },
  {
    ...
    localNames: { ja: '腱板断裂', es: 'Desgarro del manguito rotador', fr: 'Déchirure de la coiffe des rotateurs', zh: '旋转肌袖撕裂', ko: '회전근개 파열' },
  ...
  },
  {
    ...
    localNames: { ja: '腰椎椎間板ヘルニア（L4–L5）', es: 'Hernia discal L4–L5', fr: 'Hernie discale L4–L5', zh: '腰椎间盘突出', ko: '허리 추간판 탈출증' },
  ...
  },
  {
    ...
    localNames: { ja: '骨減少症', es: 'Osteopenia', fr: 'Ostéopénie', zh: '骨质减少症', ko: '골감소증' },
  ...
  },
  {
    ...
    localNames: { ja: '高血圧症', es: 'Hipertensión arterial', fr: 'Hypertension artérielle', zh: '高血压', ko: '고혈압' },
  ...
  },
  {
    ...
    localNames: { ja: '心房細動', es: 'Fibrilación auricular', fr: 'Fibrillation auriculaire', zh: '心房颤动', ko: '심방세동' },
  ...
  },
  {
    ...
    localNames: { ja: '反応性リンパ節腫脹', es: 'Linfadenopatía reactiva', fr: 'Lymphadénopathie réactionnelle', zh: '反应性淋巴结病', ko: '반응성 림프절병증' },
  ...
  },
  {
    ...
    localNames: { ja: '伝染性単核球症', es: 'Mononucleosis infecciosa', fr: 'Mononucléose infectieuse', zh: '传染性单核细胞增多症', ko: '전염성 단핵구증' },
  ...
  },
  {
    ...
    localNames: { ja: '片頭痛', es: 'Migraña con aura', fr: 'Migraine avec aura', zh: '偏头痛', ko: '편두통' },
  ...
  },
  {
    ...
    localNames: { ja: '手根管症候群', es: 'Síndrome del túnel carpiano', fr: 'Syndrome du canal carpien', zh: '腕管综合征', ko: '수근관 증후군' },
  ...
  },
  {
    ...
    localNames: { ja: '気管支喘息', es: 'Asma bronquial', fr: 'Asthme bronchique', zh: '支气管哮喘', ko: '기관지 천식' },
  ...
  },
  {
    ...
    localNames: { ja: '新型コロナウイルス感染症', es: 'COVID-19', fr: 'COVID-19', zh: '新冠肺炎', ko: '코로나19' },
  ...
  },
  {
    ...
    localNames: { ja: '胃食道逆流症', es: 'Enfermedad por reflujo gastroesofágico', fr: 'Reflux gastro-œsophagien', zh: '胃食管反流病', ko: '위식도 역류질환' },
  ...
  },
  {
    ...
    localNames: { ja: '過敏性腸症候群', es: 'Síndrome del intestino irritable', fr: 'Syndrome de l\'intestin irritable', zh: '肠易激综合征', ko: '과민성 대장 증후군' },
  ...
  },
  {
    ...
    localNames: { ja: '尿路結石', es: 'Litiasis renal', fr: 'Lithiase rénale', zh: '肾结石', ko: '신장 결석' },
  ...
  },
  {
    ...
    localNames: { ja: '再発性尿路感染症', es: 'Infecciones urinarias recurrentes', fr: 'Infections urinaires récurrentes', zh: '复发性尿路感染', ko: '재발성 요로감염' },
  ...
  },
  {
    ...
    localNames: { ja: '甲状腺機能低下症', es: 'Hipotiroidismo', fr: 'Hypothyroïdie', zh: '甲状腺功能减退症', ko: '갑상선 기능 저하증' },
  ...
  },
  {
    ...
    localNames: { ja: 'ビタミンD欠乏症', es: 'Deficiencia de vitamina D', fr: 'Carence en vitamine D', zh: '维生素D缺乏症', ko: '비타민 D 결핍증' },
  ...
  },
  {
    ...
    localNames: { ja: '子宮筋腫', es: 'Fibromas uterinos', fr: 'Fibromes utérins', zh: '子宫肌瘤', ko: '자궁 근종' },
  ...
  },
  {
    ...
    localNames: { ja: '多嚢胞性卵巣症候群', es: 'Síndrome de ovario poliquístico', fr: 'Syndrome des ovaires polykystiques', zh: '多囊卵巢综合征', ko: '다낭성 난소 증후군' },
